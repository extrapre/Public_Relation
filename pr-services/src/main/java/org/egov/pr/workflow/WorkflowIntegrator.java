...
public class WorkflowIntegrator {
	...
	@Autowired
	public WorkflowIntegrator(RestTemplate rest, PrConfiguration config) {
		this.rest = rest;
		this.config = config;
	}
	 ...
	 */
	public void callWorkFlow(PrRequest prRequest) {
/*
		String wfTenantId = prRequest.getLicenses().get(0).getTenantId();

		JSONArray array = new JSONArray();
		for (TradeLicense license : prRequest.getLicenses()) {
