...
import org.egov.pr.web.models.user.CreateUserRequest;
import org.egov.pr.web.models.user.UserDetailResponse;
import org.egov.pr.web.models.user.UserSearchRequest;
...
public class UserService{
    ...
    @Autowired
    public UserService(ObjectMapper mapper, ServiceRequestRepository serviceRequestRepository, PrConfiguration config) {
        this.mapper = mapper;
