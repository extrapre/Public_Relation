...
public class MDMSValidator {
    ...
    @Autowired
    public MDMSValidator(ServiceRequestRepository requestRepository, PrUtil util,
    ...
    private Map<String, List<String>> getAttributeValues(Object mdmsData) {
        ...
        List<String> modulepaths = Arrays.asList(PrConstants.TL_JSONPATH_CODE,
                PrConstants.COMMON_MASTER_JSONPATH_CODE);
        ...
        modulepaths.forEach( modulepath -> {
            try {
                ...
                throw new CustomException(PrConstants.INVALID_TENANT_ID_MDMS_KEY, PrConstants.INVALID_TENANT_ID_MDMS_MSG);
            }
        });
    ...
    private Map getTradeTypeUomMap(Object mdmsData){
        ...
        List<String> tradeTypes = JsonPath.read(mdmsData,PrConstants.TRADETYPE_JSONPATH_CODE);
        List<String> tradeTypeUOM = JsonPath.read(mdmsData,PrConstants.TRADETYPE_JSONPATH_UOM);
    ...
    private Map getAccessoryUomMap(Object mdmsData){
        ...
        List<String> accessories = JsonPath.read(mdmsData,PrConstants.ACCESSORY_JSONPATH_CODE);
        List<String> accessoryUOM = JsonPath.read(mdmsData,PrConstants.ACCESSORY_JSONPATH_UOM);
